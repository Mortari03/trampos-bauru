    ...
    <div className="ce-container">
      <div className="ce-content">
        <div className="ce-image">
          <img src="/img/cadastroempresa.png" alt="Ilustração" />
        </div>
        <div className="ce-form">
          ...
          <h1 className="ce-title">
            Já Imaginou o jeito fácil de publicar <br /> e acompanhar Suas
            Vagas?
          </h1>
          ...
          <form className="ce-form-group">
            <input
              ...
              className="ce-input"
            />
            <input type="email" placeholder="Email" className="ce-input" />
            <input type="password" placeholder="Senha" className="ce-input" />
            <input type="text" placeholder="CNPJ" className="ce-input" />
          </form>
