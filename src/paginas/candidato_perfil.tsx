        ...
        <div className='MainContent'>
          ...
          <div className='UltimoEmprego'>
            ...
            <textarea
              id='BioEmprego'
              name=''
              placeholder='Descreva seu ultimo emprego...'
            ></textarea>
          </div>
          ...
          <div className='Educação'>
            ...
            <textarea
              name='BioEducação'
              id=''
              placeholder='Qual seu nível academico?'
            ></textarea>
          </div>
          ...
          <div className='Habilidades'>
            ...
            <textarea
              id='BioHabilidade'
              name=''
              placeholder='Quais são suas habilidades?'
            ></textarea>
          </div>
          ...
          <div className='Certificações'>
            ...
            <label htmlFor='resume'>Anexar certificações</label>{" "}
            <input
              type='file'
              id='resume'
            />
          ...
          <div className='Cursos'>
            ...
            <textarea
              id='BioCursos'
              name=''
              placeholder='Tem algum curso? Quais são eles...'
            ></textarea>
          </div>
          ...
          <div className='RedesSocias'>
            {" "}
            <h2 className='RedesSociaisH2'>Redes Socias</h2>
            <label
              className='BarraRedeSocial'
              htmlFor='github'
            >
              GitHub:
            </label>
